...
| feature/ai-todo-hotkeys | 全局热键新增：唤起 AI 问答（Ctrl+Alt+A）/ 待办汇总面板唤出·收起（Ctrl+Alt+T）；热键注册失败留痕 + 录制期临时注销（2026-09-12） | **开发中，未合并未推送** | cdfa0f4 |

> 当前除 `feature/ai-todo-hotkeys` 外无其他未合并分支。**只登记「未合并的活跃分支」，合并即删即除名。**
