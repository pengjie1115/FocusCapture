...
| 分支 | 功能板块 | 状态 | 最后提交 |
|------|---------|------|---------|
| main | 主线（含 2026-09-11 自动化检查点体系、2026-09-12 行身份改造 + 全局热键、2026-09-12 灵感速览时间筛选重构、2026-09-13 灵感速览可组装标题栏 + 窗口壳升级 + 界面快照工具，REGRESSION B-11/B-12） | 活跃 | 785e730 |
| feature/rich-input-attachments | AI 问答输入框附件（图片/文档混排 + 内联附件块 + 气泡同款卡片 + 附件服务）+ 打开后焦点不落输入框修复 + 输入区 8 项交互修复（卡片对齐/光标色/最小高度/矢量加号/自绘预览浮层+双击大图/拖拽命中/复制粘贴加固）；慢层检查点 75→86（H 组）；REGRESSION B-13 | **活跃（未合并）** | d70719e |

> 当前 1 个未合并的开发分支。**只登记「未合并的活跃分支」，合并即删即除名。**
