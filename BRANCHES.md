...
| 分支 | 功能板块 | 状态 | 最后提交 |
|------|---------|------|---------|
| main | 主线（含 2026-09-11 自动化检查点体系、2026-09-12 行身份改造 + 全局热键、2026-09-12 灵感速览时间筛选重构、2026-09-13 灵感速览可组装标题栏 + 窗口壳升级 + 界面快照工具、2026-09-14 AI 问答附件（图片/文档混排 + 附件服务 + 自绘预览浮层与双击大图）+ 输入区 8 项交互修复，REGRESSION B-11/B-12/B-13） | 活跃 | aa2ecdf |
