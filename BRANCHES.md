...
| 远程 | 分支 | tag | 备注 |
|------|------|-----|------|
| Gitee（origin） | 仅 main | v0.1.0 | 旧分支已删（2026-09-01）。2026-09-13 实测：除 main 外无分支 |
| GitHub | 仅 main | v0.1.0、**v0.2.0** | 2026-09-02 删 4 个残留；**feature/license-gate 已于 2026-09-12 补删成功**。2026-09-13 实测：除 main 外无分支 |

> **tag 差异（2026-09-13 实测）**：`v0.2.0`（`2f752f0`）**只在 GitHub，Gitee 没有**。该 tag 指向已放弃分支 `feature/license-gate` 的末位提交（功能已 cherry-pick 进 main，但 tag 没打在主线提交上）——历史遗留，不影响代码完整性，详见第四节留档。
